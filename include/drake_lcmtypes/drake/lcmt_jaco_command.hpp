...
#ifndef __drake_lcmt_jaco_command_hpp__
#define __drake_lcmt_jaco_command_hpp__
...
int lcmt_jaco_command::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_jaco_command::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lcmt_jaco_command::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lcmt_jaco_command::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lcmt_jaco_command::getTypeName()
{
    return "lcmt_jaco_command";
}

int lcmt_jaco_command::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_jaco_command::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int lcmt_jaco_command::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t lcmt_jaco_command::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x4a39790e1f27e20bLL;
