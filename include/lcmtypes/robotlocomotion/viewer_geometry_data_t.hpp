...
#ifndef __robotlocomotion_viewer_geometry_data_t_hpp__
#define __robotlocomotion_viewer_geometry_data_t_hpp__
...
int viewer_geometry_data_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    this->string_data.assign(static_cast<const char*>(buf) + offset + pos, __string_data_len__ - 1);
