...
int printf_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    this->deputy_name.assign(static_cast<const char*>(buf) + offset + pos, __deputy_name_len__ - 1);
    ...
    this->text.assign(static_cast<const char*>(buf) + offset + pos, __text_len__ - 1);
    pos += __text_len__;
