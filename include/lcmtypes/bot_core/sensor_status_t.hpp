...
class sensor_status_t
{
    ...
    public:
        static constexpr int16_t  VELODYNE_32 = 0;
        static constexpr int16_t  VELODYNE_64 = 1;
        static constexpr int16_t  SICK_LASER = 2;
        static constexpr int16_t  HOKUYO_LASER = 3;
        static constexpr int16_t  KINECT = 4;
        static constexpr int16_t  IMU = 5;
        static constexpr int16_t  ORC = 6;
        static constexpr int16_t  DYNAMIXEL_SERVO = 7;
...
int sensor_status_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    this->sensor_name.assign(static_cast<const char*>(buf) + offset + pos, __sensor_name_len__ - 1);
