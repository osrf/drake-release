...
class images_t
{
    ...
    public:
        ...
        static constexpr int16_t  RIGHT = 1;
        static constexpr int16_t  DISPARITY = 2;
        static constexpr int16_t  MASK_ZIPPED = 3;
        static constexpr int16_t  DEPTH_MM = 4;
        static constexpr int16_t  DISPARITY_ZIPPED = 5;
        static constexpr int16_t  DEPTH_MM_ZIPPED = 6;
...
uint64_t images_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == images_t::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, images_t::getHash };
