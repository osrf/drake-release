...
set(_vtk_installed_prefix "/opt/drake/lib/cmake/vtk-8.0")
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/opt/drake/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/opt/drake/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/home/vagrant/vtk-build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/home/vagrant/vtk-build/lib")
  endif ()
endif()
