...
set(_expectedTargets scs::scsindir scs::scsdir)
...
set(scs_VERSION "1.2.6")

add_library(scs::scsindir SHARED IMPORTED)
set_target_properties(scs::scsindir PROPERTIES
  IMPORTED_LOCATION "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/lib/libscsindir.so"
  INTERFACE_INCLUDE_DIRECTORIES "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/include/scs"
  INTERFACE_COMPILE_DEFINITIONS "LAPACK_LIB_FOUND=1"
)

add_library(scs::scsdir SHARED IMPORTED)
set_target_properties(scs::scsdir PROPERTIES
  IMPORTED_LOCATION "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/lib/libscsdir.so"
  INTERFACE_INCLUDE_DIRECTORIES "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/include/scs"
  INTERFACE_COMPILE_DEFINITIONS "LAPACK_LIB_FOUND=1"
)

set(scs_LIBRARIES "scs::scsdir")
set(scs_INCLUDE_DIRS "")
