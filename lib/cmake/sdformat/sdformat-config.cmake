...
set(_expectedTargets SDFormat::sdformat)
...
set(SDFormat_VERSION "6.0.0")

add_library(SDFormat::sdformat SHARED IMPORTED)
set_target_properties(SDFormat::sdformat PROPERTIES
  IMPORTED_LOCATION "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/lib/libsdformat.so"
  INTERFACE_INCLUDE_DIRECTORIES "${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ignition-math3::ignition-math3;-ltinyxml"
)

set(SDFormat_LIBRARIES "SDFormat::sdformat")
set(SDFormat_INCLUDE_DIRS "")
